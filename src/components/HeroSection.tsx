      ...
      <div className="container relative z-10 px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border bg-secondary/50 mb-8 animate-fade-in">
            ...
            <span className="text-sm text-muted-foreground font-medium">Available for Executive Opportunities</span>
          </div>
          ...
          {/* Title */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-4 animate-slide-up font-display font-medium" style={{ animationDelay: '0.2s' }}>
            Technology Executive & Entrepreneur
          </p>

          {/* Impact statement */}
          <p className="text-lg md:text-xl text-muted-foreground/80 max-w-2xl mx-auto mb-8 animate-slide-up leading-relaxed" style={{ animationDelay: '0.3s' }}>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '0.5s' }}>
