  ...
  const careerItems: CareerItem[] = [
    {
      ...
      highlights: [
        "Managing Comet AI browser launch with 9,000+ ambassadors worldwide",
        "45% engagement boost through strategic initiative planning",
        "60% reduction in reporting time via automated systems"
      ],
      type: "work"
    },
    {
      ...
      highlights: [
        "32% user retention increase for Adobe Acrobat Reader",
        "65% install growth through strategic product improvements",
        "UI/UX redesign based on 300+ user surveys"
      ],
      type: "work"
    },
    {
      ...
      highlights: [
        "$7.5M+ ROI through cost-benefit analyses",
        "50% bottleneck reduction in production workflows",
        "96% on-time delivery rate for VFX projects"
      ],
      type: "work"
    },
    {
      ...
      highlights: [
        "3x ROI investment models for studio productions",
        "$250K budget reallocation optimizing VFX spending",
    ...
    },
    {
      ...
      highlights: [
        "Raised $7.4M and led company to successful IPO (IDX: MMIX)",
        "40,000+ retail store placements across Indonesia",
        "Built top 5 consumer healthcare brand nationwide"
      ],
      type: "work"
    }
  ];
