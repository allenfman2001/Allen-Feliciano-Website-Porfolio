...
const FilmsSection = () => {
  return <section id="films" className="py-20 md:py-32 bg-secondary/30">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto grid gap-6">
          {films.map((film, index) => <a key={index} href={film.link} target="_blank" rel="noopener noreferrer" className="group bg-card border border-border rounded-xl p-6 flex items-center gap-4 hover:border-primary/50 hover:shadow-lg transition-all duration-300">
